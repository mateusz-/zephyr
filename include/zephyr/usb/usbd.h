...
/* TODO: Kconfig option CONFIG_USBD_NUMOF_INTERFACES_MAX? */
...
struct usbd_ch9_data {
	...
	int (*completion_cb)(void *const context, void *const data);
...
struct usbd_class_api {
	...
	int (*control)(struct usbd_class_node *const node,
