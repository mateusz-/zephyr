...
* Provides a programming interface that's used by a customer applications.
  ...
  :zephyr_file:`include/zephyr/usbc/usbc_device.h`
...
Implementing a Sink Type-C and Power Delivery USBC device
*********************************************************
...
* Devicetree usbc-port node referencing a TCPC
...
Each Physical Type-C port is represented in the devicetree by a usbc-port compatible
node:

.. literalinclude:: ../../../samples/subsys/usbc/sink/boards/b_g474e_dpow1.overlay
   :language: dts
...
vbus-voltage-divider-adc compatible node:
...
.. literalinclude:: ../../../samples/subsys/usbc/sink/src/main.c
   :language: c
