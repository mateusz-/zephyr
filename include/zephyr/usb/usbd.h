...
/**
 * USB device control request completion structure
 */
struct usbd_req_compl {
	/** Setup request completion callback */
	int (*cb)(void *const context, void *const data);
	/** Setup request completion callback data */
	void *data;
};
...
struct usbd_ch9_data {
	...
	struct usbd_req_compl req_compl;
};
